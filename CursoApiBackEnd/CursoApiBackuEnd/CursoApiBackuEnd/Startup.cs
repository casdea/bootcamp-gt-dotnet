...
using CursoApiBackuEnd.Infraestruture.Data.Repositories;
using CursoApiBackuEnd.Configurations;

namespace CursoApiBackuEnd
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            /*   services.AddControllers()
               ...
               {
                   c.SwaggerDoc("v1", new OpenApiInfo { Title = "CursoApiBackuEnd", Version = "v1" });
               });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "CursoApiBackuEnd v1"));
            }
